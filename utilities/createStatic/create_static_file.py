...
dem_path_tif = static_folder + 'DEM/FullDEM.tif'
### input shape of glacier or study area, e.g. from the Randolph glacier inventory
shape_path = static_folder + 'Shapefiles/Alaknanda_Sarswati_Glacier.shp'
### path were the static.nc file is saved
output_path = static_folder + 'Sato_staticO.nc'

### to shrink the DEM use the following lat/lon corners
longitude_upper_left = '78.9375'
latitude_upper_left = '32.0625'
longitude_lower_right = '80.0625'
latitude_lower_right = '29.9375'

### to aggregate the DEM to a coarser spatial resolution
aggregate_degree = '0.125'
